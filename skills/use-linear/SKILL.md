...
| **Manual numbering in titles**      | Prefixing titles with "1.", "#3 -", "Step 2:", etc.                                 | Titles are plain text; Linear issues the canonical ID (`ENG-123`) — never embed a manual number in the title          |
